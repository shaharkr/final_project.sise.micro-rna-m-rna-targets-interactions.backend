...
#         # Create train_test
#         ###########################################3
#         mockMrna = Process(target=create_stratify_train_test_split, args=(csv_dir, train_test_dir, 0.2, i*7))
#         mockMrna.start()
#         process_list.append(mockMrna)
#     for mockMrna in process_list:
#         mockMrna.join()
#
#     if stat:
#         # process_list = []
#         # for i in range(10):
#         #     mockMrna = Process(target=dataset_statistics, args=(i, ))
#         #     mockMrna.start()
#         #     process_list.append(mockMrna)
#         # for mockMrna in process_list:
#         #     mockMrna.join()
